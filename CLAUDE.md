...
- **Site description**: `_config.yml` `description` — customized for SEO
- **Google Search Console**: verified via `googleedab7dd85fe78e45.html` in repo root
- **Sitemap**: `sitemap.xml` submitted to Google Search Console (generated by `jekyll-sitemap` plugin)
