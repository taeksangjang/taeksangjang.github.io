# Homepage Research Introduction Revision

## Objective

Replace the homepage's one-sentence research statement with the approved two-sentence research introduction.
...
- Preserve the preceding PhD-student introduction and the following education paragraph.
